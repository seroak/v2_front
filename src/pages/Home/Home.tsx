      ...
      <section className={styles["main02"]}>
        ...
        <section className={styles["main03"]}>
          <div className={styles["main-container"]}>
            <div className={styles["main-row"]}>
              <img
                className={styles["pc-only"]}
                src="/image/img_main_sec03.png"
                alt="코드 교정 및 힌트 이미지"
              />
              <img
                className={styles["mobile-only"]}
                src="/image/img_main_sec03_m.png"
                alt="코드 교정 및 힌트 이미지"
              />
        ...
        <section className={styles["main04"]}>
          <div className={styles["main-container"]}>
            <div className={styles["main-row"]}>
              ...
              <img
                className={styles["pc-only"]}
                src="/image/img_main_sec04.png"
                alt="코딩 교육 플랫폼 이미지"
              />
              <img
                className={styles["mobile-only"]}
                src="/image/img_main_sec04_m.png"
                alt="코딩 교육 플랫폼 이미지"
              />
            </div>
          </div>
        ...
        <section className={styles["main05"]}>
          ...
          <h2>
            코딩 교육의 시작,<br className="mobile-only" />
            에듀파이와 함께하세요!
          </h2>
          <p>edupi와 함께 파이썬 공부를 쉽고 재밌게 하세요.</p>
          <Link className={styles["btn_cta"]} to="/viz">
